...
<br><br>
    <center><p style="font-size: 50px; color: rgb(202, 255, 255); font-family: Calibri;">
            <b>Add new doctor's Information</b>
    </p></center>
    ...
    <div class= "card border-1 shadow-lg">
        <div class="card-body">
           ...
           <div class= "col-md-4 mb-3">
            ...
            <input type="text" name="degree" id="degree" placeholder="Enter Degree" class="form-control @error('degree') is-invalid @enderror"  value="{{old('degree')}}">
            @error('degree') <p class="invalid-feedback">{{$message}}</p> @enderror
           </div> 

           <div class= "col-md-4 mb-3">
            <label for="branch" class="form-label">Branch</label>
            <input type="text" name="branch" id="branch" placeholder="Enter Branch" class="form-control @error('branch') is-invalid @enderror"  value="{{old('branch')}}">
           ...
           <div class= "col-md-4 mb-3">
            ...
            <input type="text" name="working_place" id="working_place" placeholder="Enter the place he/she is working" class="form-control @error('working_place') is-invalid @enderror"  value="{{old('working_place')}}">
           ...
           <div class= "col">
            ...
            <input type="text" name="call_for_serial" id="call_for_serial" placeholder="Enter contact number to make an appointment" class="form-control @error('call_for_serial') is-invalid @enderror"  value="{{old('call_for_serial')}}">
           ...
           <button class="btn btn-primary mt-2">Save Doctor's Information</button>
        </div>
    </div>
    </form></div>
